...
def block_content(context, missing=missing):
    ...
    yield escape(t_3(t_2(context.eval_ctx, environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'status'), '_', ' ')))
    yield '</h2>\n                </div>\n                '
    if environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'fallback_used'):
        pass
    ...
    yield escape(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'db_type'))
    if environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'provider'):
        pass
        yield ' / '
        yield escape(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'provider'))
    yield '</strong>\n                </div>\n                <div class="rounded-2xl border border-white/5 bg-[#0d0f0f] p-4">\n                    <p class="text-[10px] uppercase tracking-[0.18em] text-[#8a9291] font-bold mb-2">Host</p>\n                    <strong class="break-all">'
    yield escape((environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'host') or 'local file'))
    yield '</strong>\n                </div>\n                <div class="rounded-2xl border border-white/5 bg-[#0d0f0f] p-4">\n                    <p class="text-[10px] uppercase tracking-[0.18em] text-[#8a9291] font-bold mb-2">Database</p>\n                    <strong class="break-all">'
    yield escape((environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'database') or 'unknown'))
    yield '</strong>\n                </div>\n                <div class="rounded-2xl border border-white/5 bg-[#0d0f0f] p-4">\n                    <p class="text-[10px] uppercase tracking-[0.18em] text-[#8a9291] font-bold mb-2">Migration</p>\n                    <strong>'
    yield escape((environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'alembic_version') or 'not recorded'))
    yield '</strong>\n                </div>\n            </div>\n            <div class="mt-4 grid gap-3 md:grid-cols-3">\n                <div class="rounded-2xl border border-white/5 bg-[#0d0f0f] p-4">\n                    <p class="text-[10px] uppercase tracking-[0.18em] text-[#8a9291] font-bold mb-2">Vocabulary</p>\n                    <strong class="font-[\'Manrope\'] text-3xl">'
    yield escape((environment.getattr(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'counts'), 'vocabulary_master') if (not t_4(environment.getattr(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'counts'), 'vocabulary_master'))) else '-'))
    yield '</strong>\n                </div>\n                <div class="rounded-2xl border border-white/5 bg-[#0d0f0f] p-4">\n                    <p class="text-[10px] uppercase tracking-[0.18em] text-[#8a9291] font-bold mb-2">Users</p>\n                    <strong class="font-[\'Manrope\'] text-3xl">'
    yield escape((environment.getattr(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'counts'), 'users') if (not t_4(environment.getattr(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'counts'), 'users'))) else '-'))
    yield '</strong>\n                </div>\n                <div class="rounded-2xl border border-white/5 bg-[#0d0f0f] p-4">\n                    <p class="text-[10px] uppercase tracking-[0.18em] text-[#8a9291] font-bold mb-2">Enrichments</p>\n                    <strong class="font-[\'Manrope\'] text-3xl">'
    yield escape((environment.getattr(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'counts'), 'vocabulary_enrichment') if (not t_4(environment.getattr(environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'counts'), 'vocabulary_enrichment'))) else '-'))
    yield '</strong>\n                </div>\n            </div>\n            '
    if environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'missing_tables'):
        pass
        yield '\n            <p class="mt-4 mb-0 text-sm text-[#ffb4ab]">Missing tables: '
        yield escape(t_1(context.eval_ctx, environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'missing_tables'), ', '))
        yield '. Run the Alembic migrations before using this database.</p>\n            '
    yield '\n            '
    if environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'warnings'):
        pass
        yield '\n            <p class="mt-4 mb-0 text-sm text-[#dec38f]">'
        yield escape(t_1(context.eval_ctx, environment.getattr((undefined(name='db_health') if l_0_db_health is missing else l_0_db_health), 'warnings'), ' '))
        yield '</p>\n            '
...
debug_info = '1=12&3=17&5=27&19=76&20=78&21=80&30=82&31=84&32=86&35=88&44=90&48=92&52=94&56=96&60=98&64=100&68=102&72=104&76=106&84=108&86=110&95=117&99=123&103=125&107=127&113=129&117=131&121=133&124=135&125=138&127=141&128=144&138=147&141=149&156=151&159=156&160=158&161=160&165=164&166=166&168=168&169=170&170=172&171=174&172=176&173=178&178=180&179=182&189=186&190=192&191=194&201=200&205=202&206=206&211=216&212=220&218=230&221=235&222=237&223=239&225=241&226=243&227=245&229=247&230=251&238=261&243=269&244=275&245=277&255=283&275=285&278=290&279=292&280=294&281=297&284=300&285=302&286=304&287=306&288=308&289=310&290=312&292=314&299=321&300=323&301=325&310=332&311=334&314=336&315=339&324=344&325=350&326=352'