...
<section class="dashboard-page-wrap">
    <header class="dashboard-topbar">
        ...
        <div class="dashboard-topbar-actions">
            <a class="dashboard-topbar-cta" href="{{ url_for('dashboard') }}#generate-section">New Session</a>
    ...
    <div class="dashboard-layout">
        <aside class="dashboard-sidebar">
            ...
            <nav class="dashboard-sidebar-nav">
                ...
                <a class="is-active" href="{{ url_for('words') }}">
        ...
        <section class="dashboard-main">
            ...
            <div class="tw-scope px-6 max-w-full font-body antialiased" style="margin-top: 1rem;">
                <!-- Filter Section -->
                                    ...
                                    <div class="flex justify-end items-center gap-3">
                                        <form method="post" action="{{ url_for('toggle_favorite_flag', user_word_id=item.id) }}">
                                            ...
                                            <button type="submit" class="{{ 'text-secondary' if item.is_favorite else 'text-outline-variant hover:text-secondary' }} transition-colors" title="Favorite" onclick="event.stopPropagation();">
                                                <span class="material-symbols-outlined text-lg bg-transparent border-none p-0" data-icon="star" {% if item.is_favorite %}style="font-variation-settings: 'FILL' 1;"{% endif %}>star</span>
                                            </button>
                                        </form>
                                        <form method="post" action="{{ url_for('toggle_difficult_flag', user_word_id=item.id) }}">
                                            ...
                                            <button type="submit" class="{{ 'text-primary' if item.is_difficult else 'text-outline-variant hover:text-primary' }} transition-colors" title="Difficult" onclick="event.stopPropagation();">
                                                <span class="material-symbols-outlined text-lg bg-transparent border-none p-0" data-icon="priority_high" {% if item.is_difficult %}style="font-variation-settings: 'FILL' 1;"{% endif %}>priority_high</span>
                                            </button>
                                        </form>
                                    </div>
                                </summary>
...
print("words.html updated successfully with Full Layout integrations!")
